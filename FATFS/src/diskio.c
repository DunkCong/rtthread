...
{				 
  ...
  HAL_RTC_GetDate(&RTC_Handler,&RTC_DateStruct,RTC_FORMAT_BIN);	
	...
	return (RTC_DateStruct.Year+20)<<25 | RTC_DateStruct.Month<<21 | RTC_DateStruct.Date<<16 | RTC_TimeStruct.Hours<<11 | RTC_TimeStruct.Minutes<<5 | RTC_TimeStruct.Seconds/2 ;
}			 
//动态分配内存
